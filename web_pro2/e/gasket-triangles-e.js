...
window.onload = function initTriangles(){
	...
	var canshu2=document.getElementById("myID2");
	var canshu=document.getElementById("myID");
	...
	canshu.onmouseup=function(){
		points=[];
		numTimesToSubdivide=canshu.value;
		initTriangles();
	}
	canshu2.onmouseup=function(){
		points=[];
		theta=canshu2.value;
		initTriangles();
	}
