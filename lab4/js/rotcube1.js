...
window.onload = function initCube() 
{
	...
	moveLoc = gl.getUniformLocation(program, "yidong");
	gl.uniform3fv(moveLoc, mo_ve);
	
	sf_mat = gl.getUniformLocation(program,'suofang');
	gl.uniform3fv(sf_mat, sf);
	...
	document.getElementById("zon").onclick = function () {
	    mo_ve[2]+=0.5;
	}
	document.getElementById("zdown").onclick = function () {
	    mo_ve[2]-=0.5;
	}
	document.getElementById("xbig").onclick = function () {
	    sf[0]+=0.2;
	}
	document.getElementById("xsmall").onclick = function () {
	    sf[0]-=0.2;
	}
	document.getElementById("ybig").onclick = function () {
	    sf[1]+=0.2;
	}
	document.getElementById("ysmall").onclick = function () {
	    sf[1]-=0.2;
	}
	document.getElementById("zbig").onclick = function () {
	    sf[2]+=0.2;
	}
	document.getElementById("zsmall").onclick = function () {
	    sf[2]-=0.2;
	}
    render();
}
